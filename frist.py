# Repo: https://github.com/MD-hanter_xd-CYBER
# Author: @MD-hanter_xd-CYNER
# Update at: 17 January 20 23.17
import os
import sys
import re
import datetime
...
def main():
    if len(sys.argv) != 2:
        exit("usage: frist file_name.py")
    globals()['dah_lah']=sys.argv[1]
    sys.argv=[dah_lah,"code.py",".frist_key"]
